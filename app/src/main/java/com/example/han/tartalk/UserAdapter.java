...
// */
//
//class UserAdapter extends HFRecyclerViewAdapter<User, UserAdapter.PostViewHolder> {
//
...
//
//        super(context);
//        databaseComments = FirebaseDatabase.getInstance().getReference().child("Users");
//    }
//
//    @Override
...
//
//        //if(holder.txtViewContent.)
////        int x = getData().get(position).content.length() % 20;
////
////        if(x == 0) {
////            holder.txtViewContent.setText(getData().get(position).content);
////        }else{
////
////            holder.txtViewContent.setMaxWidth();
////        }
////
//
...
//
//
//                            databaseComments.child(getData().get(position).id).child("comments").push().setValue(comment).addOnCompleteListener(new OnCompleteListener<Void>() {
//                                @Override
